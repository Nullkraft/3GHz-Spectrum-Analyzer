...
#include "adf4356.h"
    // Default constructor
    // ADF4356_LO::ADF4356_LO(int num_funcs) {
    //     NUMBER_OF_FUNCTIONS = static_cast<int>num_funcs;
    // }

    // ADF4356_LO::Constructor
    void ADF4356_LO::begin(float initial_frequency) {
        // TODO: Initialize adf4356 chip
    }
