...
/************************************************
    Name    : Project1_Load_146p52_16TERM.ino
    ...
    Notes   : Code for Attenuator, (1)ADF4356 (2)MAX2871 LO2=3945MHz LO3=270MHz REF=60MHz PFD=5 MHz
              LO2 frequency=3945MHz Atten=31.75 dB  Serial=115200
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.print("Project1_Load_146p52_16TERM.ino Use w/ ADF4356_4_Sweep.bas 11Sept2021 ");
