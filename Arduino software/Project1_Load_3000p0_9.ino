...
//************************************************//
//  Name    : Project1_Load_3000p0_9.ino        //
//  Author  : WN2A                                //
//  Date    : 26 June 2021                          //
//  Version : 3.0              //
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println ("Project1_Load_3000p0_9.ino for Project#1 Spectrum Analyzer RF=3000MHz");
  Serial.println("Programs PE Digital Attenuator for 16 dB   IF1=3630MHz IF2=315MHz IF3=45MHz");
  Serial.println("Program L01 ADF4356 Synthesizer Vco=6630 MHz Ref=60 MHz PFD=5MHz?? (14 Registers)");  
